...
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Lebensraum[ENDCOLOR]: Erhaltet [ICON_CULTURE] Kultur und [ICON_GOLDEN_AGE] Goldenes Zeitalter Punkte, wenn sich Eure Grenzen weiten. Geländefeld-Erschließung durch Zitadelle verdoppelt.'
...
UPDATE language_de_DE
SET Text = 'Lebensraum war eine Ideologie, die eine aggressive Expansion Deutschlands und des deutschen Volkes vorschlug. Unter dem Deutschen Reich entwickelt, wurde es Teil der deutschen Ziele im Ersten Weltkrieg und wurde später als wichtiger Bestandteil der nationalsozialistischen Ideologie in Deutschland angenommen.'
...
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Avant Garde[ENDCOLOR]: Die Geburtenrate von [ICON_GREAT_PEOPLE] Großen Persönlichkeiten wird um 33% erhöht. -10% [ICON_HAPPINESS_3] Unzufriedenheit durch [ICON_CULTURE] Langeweile.'
...
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Freihandel[ENDCOLOR][NEWLINE]Große Händler werden 50% schneller generiert. +5 [ICON_GOLD] Gold von [ICON_INTERNATIONAL_TRADE] Internationalen Handelswegen. Armutsschwelle in allen Städten um 10% gesenkt.'
...
UPDATE language_de_DE
SET Text = 'Der Freihandel ist eine Politik, die von einigen internationalen Märkten verfolgt wird, auf denen die Regierungen die Einfuhren aus oder die Ausfuhren in andere Länder nicht einschränken. Der Freihandel wird durch den Europäischen Wirtschaftsraum und das Nordamerikanische Freihandelsabkommen veranschaulicht, die offene Märkte geschaffen haben. Die meisten Nationen sind heute Mitglieder der multilateralen Handelsabkommen der Welthandelsorganisation (WTO). Die meisten Regierungen setzen jedoch nach wie vor protektionistische Maßnahmen zur Förderung der lokalen Beschäftigung durch, wie z.B. die Anwendung von Zöllen auf Importe oder Subventionen für Exporte. Die Regierungen können auch den Freihandel einschränken, um die Ausfuhr natürlicher Ressourcen zu begrenzen. Weitere Handelshemmnisse sind Importquoten, Steuern und nichttarifäre Handelshemmnisse, wie z.B. Regulierungsvorschriften.'
...
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Imperialismus[ENDCOLOR] verbessert Ihre Fähigkeit, Ihr Reich durch militärische Macht zu erweitern, insbesondere durch die Vorherrschaft der Marine (und später der Lufthoheit).[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Die Einführung des Imperialismus bringt:[ENDCOLOR][NEWLINE][ICON_BULLET] +1[ICON_MOVES] Fortbewegung für Marineeinheiten, gewasserten Einheiten und [ICON_GREAT_GENERAL] Große Generäle, sowie +1 Sicht für Nahkampfeinheiten der Marine und der Landeinheiten.[NEWLINE][ICON_BULLET] +10% [ICON_PRODUCTION] Produktion für militärische Einheiten, -10% [ICON_GOLD] Gold erforderlich für Modernisierungen.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Jede freigeschaltete Imperialismuspolitik bringt:[ENDCOLOR] [NEWLINE][ICON_BULLET] +5% [ICON_PRODUCTION] Produktion für militärische Einheiten, -5% [ICON_GOLD] Gold erforderlich für Modernisierungen.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Die Einführung aller Politiken im Zweig Imperialismus bringt:[ENDCOLOR][NEWLINE][ICON_BULLET] Schaltet das Gebäude [COLOR_CYAN]Pentagon[ENDCOLOR] frei. [NEWLINE][ICON_BULLET] Jede Lufteinheit, die in einer Stadt stationiert ist, erhöht die Verteidigung der Stadt um 3 und reduziert die [ICON_HAPPINESS_3] Unzufriedenheit durch Bedürfnisse um 2%.[NEWLINE][ICON_BULLET] Alle Marine-Einheiten erhalten die [COLOR_POSITIVE_TEXT]Eisenseiten[ENDCOLOR] Beförderung (werden stärker, wenn sie Schaden nehmen).[NEWLINE][ICON_BULLET] Ermöglicht den Kauf Großer Admiräle mit [ICON_PEACE] Glauben ab dem Industriezeitalter.'
