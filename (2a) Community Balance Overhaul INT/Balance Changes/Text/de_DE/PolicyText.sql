...
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Lebensraum[ENDCOLOR][NEWLINE]Erhaltet [ICON_CULTURE] Kultur und [ICON_GOLDEN_AGE] Goldenes Zeitalter Punkte, wenn sich Eure Grenzen weiten. Geländefeld-Erschließung durch Zitadelle verdoppelt.'
...
-- Scholasticism
UPDATE language_de_DE
SET Text = '[COLOR_POSITIVE_TEXT]Scholastik[ENDCOLOR][NEWLINE]Alle Stadtstaaten, die [COLOR_POSITIVE_TEXT]Verbündete[ENDCOLOR] sind, liefern einen [ICON_RESEARCH] Wissenschaftsbonus in Höhe von 33% ihrer Produktion.'
