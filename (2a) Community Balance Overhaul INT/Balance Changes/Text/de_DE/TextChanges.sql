...
-- Citadel Stuff
	...
	UPDATE Language_de_DE
	SET Text = 'Eine Zitadelle ist eine mächtige Festung, die nur von einem Großen General erbaut werden kann, in der Regel in der Nähe einer Stadt oder besonders schützenswerten Geländes. Die Akropolis im griechischen Athen ist ein Beispiel für eine frühe, mächtige Zitadelle. Solche Bauwerke waren durch einen direkten Angriff nahezu uneinnehmbar und sie waren in der Lage, lang andauernden Belagerungen standzuhalten, bevor sie fielen. Ihr könnt Zitadellen überall in Eurem Gebiet oder direkt an Euer Gebiet angrenzend errichten. Bei der Errichtung der Zitadelle, wird Eure Versorgungsgrenze für militärische Einheiten um 2 erhöht und die Grenzen Eurer Zivilisation um ein Feld um die Zitadelle herum erweitert. Werden dadurch Felder belegt, die bereits einer anderen Zivilisation gehören, zieht das einen diplomatischen Malus nach sich. In einer Zitadelle stationierte Einheiten erhalten 100% Bonus bei der Verteidigungsstärke. Außerdem nimmt jede feindliche Einheit, die die Runde neben einer Zitadelle beendet, 30 Schaden (Wirkung nicht kumulativ mit anderen Zitadellen).'
	...
	UPDATE Language_de_DE
	SET Text = '+100% [ICON_STRENGTH] Verteidigungsstärke für jede Einheit, die auf diesem Geländefeld stationiert ist. Jede gegnerische Einheit, die ihren Zug neben der Zitadelle beendet, erleidet 30 Schaden (Wirkung nicht kumulativ mit anderen Zitadellen). Bei der Errichtung der Zitadelle wird die Einheit verbraucht, Eure Versorgungsgrenze für militärische Einheiten um 2 erhöht und die Grenzen Eurer Zivilisation werden um die Zitadelle herum erweitert. Werden dadurch Felder belegt, die bereits einer anderen Zivilisation gehören, zieht das einen diplomatischen Malus nach sich.'
...
-- NW Stuff
	...
	UPDATE Language_de_DE
	SET Text = 'Alle Nahkampf- und berittenen Nahkampfeinheiten, die vom Besitzer dieses Naturwunders ausgebildet werden, erhalten die [COLOR_POSITIVE_TEXT]Ewige Jugend[ENDCOLOR] Beförderung. Diese Erlaubt den Einheiten sich mit einer deutlich höheren Menge zu heilen als üblich.'
	...
	UPDATE Language_de_DE
	SET Text = '[COLOR_POSITIVE_TEXT]Wohlstand[ENDCOLOR] wandelt 25% der [ICON_PRODUCTION] Produktion dieser Stadt in [ICON_GOLD] Gold um und reduziert Bedürfnisse durch [ICON_GOLD] Gold um 25%.'
	...
	UPDATE Language_de_DE
	SET Text = '[COLOR_POSITIVE_TEXT]Forschung[ENDCOLOR] wandelt 25% der [ICON_PRODUCTION] Produktion dieser Stadt in [ICON_RESEARCH] Wissenschaft um und reduziert Bedürfnisse durch [ICON_RESEARCH] Wissenschaft um 25%.'
